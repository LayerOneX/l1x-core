...
impl Stack {
	...
	impl_perform_popn_pushn!(perform_pop4_push0, 4, 0, (0, 1, 2, 3), (), unchecked_pop_push0);
	impl_perform_popn_pushn!(perform_pop6_push0, 6, 0, (0, 1, 2, 3, 4, 5), (), unchecked_pop_push0);
